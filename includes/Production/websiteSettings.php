...
/*
*******************************************************************
WebsiteSettings.php (PRODUCTION VERSION)
...
2017-09-06	Added Reviews Directory
*******************************************************************
*/	
...
// Web Site Constants
 ...
 define("DATALAYER_DIR",$ROOT . "/../datalayer");
 define("ADMIN_DIR",$ROOT . "/admin");
 define("LYRICS_DIR",$ROOT . "/lyrics");
 define("REVIEWS_DIR",$ROOT . "/reviews");
 ...
 define("RATING_ORDER","Rating");
 
 define("DEFAULT_PAGE_TITLE","...for families that LOVE music!"); 
