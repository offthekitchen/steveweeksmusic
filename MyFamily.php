<?php
	...
	//Page Name 
	$sPageName = "My Family";
	$sPageTitle = "Steve Weeks - My Family";
	//Custom FB Image
		...
		<div class="row">
			<aside class="col-xs-12 col-sm-10 col-sm-push-1">
				<div class="orange-frame frame-box in-front-of-theme-image">
					<div class="thanks">
					Below is the art, supporting documentation and audio files for the single "My Family" (MP3 and WAV).    
					</div>
				</div>
			</aside>
			<main id="main-content" class="col-xs-12">
				...
				<div class="row">
					...
					<div class="col-xs-6">
					Label and Label reference 					 
					</div>
					<div class="col-xs-6">
					Steve Weeks Music WWX1901					 
					</div>
					<div class="col-xs-6">
					Copyright(s) 					 
					</div>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-6">
						...
						<A HREF="<?php echo MP3_DIR ?>/MyFamily/MyFamily.mp3" target="_blank"><IMG SRC="<?php echo IMG_DIR ?>/mp3-icon.png" BORDER=0><br><br>
						<b>My Family MP3 (320KBps)</b></A>	
						</div>
					</div>
					<div class="col-xs-12 col-sm-6">
						<div class="presskit-document">
						<A HREF="<?php echo MP3_DIR ?>/MyFamily/MyFamily.wav" target="_blank"><IMG SRC="<?php echo IMG_DIR ?>/wav-icon.png" BORDER=0><br><br>
						<b>My Family WAV 44 16-bit</b></A>	
						</div>
					</div>
				</div>		
				<div class="row">
