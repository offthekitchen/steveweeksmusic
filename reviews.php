		...
		<div class="row">
			<aside class="col-xs-12 col-sm-10 col-sm-push-1">
				<div class="orange-frame frame-box in-front-of-theme-image">
					<div class="thanks">
					<p>Here are a few of the <em>NICE</em> things that people have said about my music.  Feel free to <em><a href="<?php echo "{$ROOT}/contact.php"; ?>">ADD YOUR VOICE</a></em>.  I'd love to know what you think. 
					</p>
					</div>
				</div>
			</aside>
			<main id="main-content" class="col-xs-12">
				<section id="review-list" class="row">
					<?php
					$nListingNumber = 1;
					foreach ($oReviews->aReviewRecords as $oReview)
					{
						echo "<div class=\"col-xs-12 col-lg-10 col-lg-push-1\">";
						echo "<aside class=\"review-listing listing-{$nListingNumber}\">";
						echo renderReview($oReview);
						echo "</aside>";
						echo "</div>";
						$nListingNumber++;
					}
