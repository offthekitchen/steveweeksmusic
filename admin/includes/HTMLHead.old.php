...
<meta property="og:description" content="<?php if ($sPageDescription) { echo "$sPageDescription";} else {echo "$sPageName";} ?>" />
...
<link rel="apple-touch-icon" href="touch-icon-iphone-admin.png">
<link rel="apple-touch-icon" sizes="152x152" href="touch-icon-ipad-admin.png">
<link rel="apple-touch-icon" sizes="180x180" href="touch-icon-iphone-retina-admin.png">
