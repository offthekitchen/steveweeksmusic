	...
	<?php
		...
		if (!is_null($nThisPerformanceID))
		{
			...
			if ($thisPerformance->getPerformance())
			{
				...
				{
					$sPerformanceURL = "http://www.steveweeksmusic.com/schedule.php?year=" . date("Y",strtotime($thisPerformance->aPerformanceRecords[0]->dtPerformanceDate)) . "&eventID=" . $thisPerformance->aPerformanceRecords[0]->nPerformanceID . "#performance-" . $thisPerformance->aPerformanceRecords[0]->nPerformanceID;
				}
				else
				{
...
?>	
				...
				<div class="table-responsive" style="font-size: 11px;">
					<table class="table table-striped">
						<tbody>
							...
							<th>Contact</th>
							<?php
								$oTourPerformance = $thisPerformance->aPerformanceRecords[0];
								echo "<tr>";
								echo "<td>";
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-xs-12"><p>Thanks so much for getting the Letter of Agreement back to  me for my performance there at <b> <?php echo $thisPerformance->aPerformanceRecords[0]->sLocation . " (" . date("l",strtotime($thisPerformance->aPerformanceRecords[0]->dtPerformanceDate)) . ", " . date("m-d-Y",strtotime($thisPerformance->aPerformanceRecords[0]->dtPerformanceDate)) . " at " . $thisPerformance->aPerformanceRecords[0]->sPerformanceTime . ")" ?></b>.&nbsp;&nbsp;&nbsp; Here's some info for you when you get a chance.<br />
			  <br />
				...
				echo $thisPerformance->aPerformanceRecords[0]->sLocation . " (" . date("l",strtotime($thisPerformance->aPerformanceRecords[0]->dtPerformanceDate)) . ", " . date("m-d-Y",strtotime($thisPerformance->aPerformanceRecords[0]->dtPerformanceDate)) . " at " . $thisPerformance->aPerformanceRecords[0]->sPerformanceTime . ")";
				echo "</a>";
				?>
				<br /><br />
  ...
  <br />
		...
		<div class="row">
			<div class="col-xs-12"><p>Hope all is well with you.<br /><br />
			  ...
			  I think I'm all set on my end for the performance at <b> <?php echo $thisPerformance->aPerformanceRecords[0]->sLocation . " (" . date("l",strtotime($thisPerformance->aPerformanceRecords[0]->dtPerformanceDate)) . ", " . date("m-d-Y",strtotime($thisPerformance->aPerformanceRecords[0]->dtPerformanceDate)) . " at " . $thisPerformance->aPerformanceRecords[0]->sPerformanceTime . ")" ?></b>.
		...
		<div class="row">
			<div class="col-xs-12"><p>Hope all is well with you.<br /><br />
			  Since it&rsquo;s about a month from my performance there at <b> <?php echo $thisPerformance->aPerformanceRecords[0]->sLocation . " (" . date("l",strtotime($thisPerformance->aPerformanceRecords[0]->dtPerformanceDate)) . ", " . date("m-d-Y",strtotime($thisPerformance->aPerformanceRecords[0]->dtPerformanceDate)) . " at " . $thisPerformance->aPerformanceRecords[0]->sPerformanceTime . ")" ?></b>, I thought I&rsquo;d  check in to see if you need anything.&nbsp; <br /><br />
		...
		<div class="row">
			<div class="col-xs-12"><p>Well, it&rsquo;s only about a week until my performance there at <b> <?php echo $thisPerformance->aPerformanceRecords[0]->sLocation . " (" . date("l",strtotime($thisPerformance->aPerformanceRecords[0]->dtPerformanceDate)) . ", " . date("m-d-Y",strtotime($thisPerformance->aPerformanceRecords[0]->dtPerformanceDate)) . " at " . $thisPerformance->aPerformanceRecords[0]->sPerformanceTime . ")" ?></b>, so I thought I&rsquo;d  check in one last time.&nbsp;&nbsp;I think I'm set on my end, but please contact me if you need anything. &nbsp; <br />
			    <br />
